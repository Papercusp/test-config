...
import { l as error, o as globalSingleton } from "./context-Mu913OAK.js";
...
function write(searchParams, key, serialized) {
...
var ThrottledQueue = class {
	...
	applyPendingUpdates(adapter, processUrlSearchParams) {
		...
		else search = write(search, key, value);
		if (processUrlSearchParams) try {
...
const globalThrottleQueue = globalSingleton("throttle-queue", () => new ThrottledQueue());
//#endregion
...
const debounceController = globalSingleton("debounce-controller", () => new DebounceController(globalThrottleQueue));
function useQueuedQueries(keys) {
	return useSyncExternalStores(keys, (key, callback) => debounceController.queuedQuerySync.on(key, callback), (key) => debounceController.getQueuedQuery(key));
}
//#endregion
export { getSearchParams as a, debounce as c, createEmitter as i, defaultRateLimit as l, useQueuedQueries as n, isAbsentFromUrl as o, globalThrottleQueue as r, write as s, debounceController as t, throttle as u };

//# sourceMappingURL=debounce-DPoC4s1g.js.map